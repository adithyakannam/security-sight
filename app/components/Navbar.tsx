            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-6">
                    <div className="flex flex-col items-end">
                        <button className="flex items-center space-x-2 bg-gray-800 hover:bg-gray-700 px-4 py-2 rounded-lg text-sm font-semibold text-white transition-colors shadow">
                            <span className="w-6 h-6 bg-gray-600 rounded-full flex items-center justify-center text-xs font-bold">
                                A
                            </span>
                            <span>Adithya</span> <br />
                        </button>
                    </div>
